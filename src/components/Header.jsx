    ...
    <header className="bg-[#1F3A93] z-50 flex justify-between items-center py-3 px-4 sm:px-10 fixed top-0 w-full h-[80px] md:h-[100px] shadow-lg">
      ...
      <a href="/" className="w-[16%] min-[568px]:w-[10%] sm:w-[12%] lg:w-[7%] xl:w-[5%]">
        ...
        >
            ...
            <HashLink smooth  to='/#carta' className="text-[#FFF3E2] text-[18px] font-bold transition duration-200 cursor-pointer">
             Nuestra Carta
            </HashLink>

            <HashLink smooth  to='/#ofertas' className="text-[#FFF3E2] text-[18px] font-bold transition duration-200 cursor-pointer">
                Ofertas
            </HashLink>

            <HashLink smooth  to='/#ubicacion' className="text-[#FFF3E2] text-[18px] font-bold transition duration-200 cursor-pointer">
                Ubicacion
            </HashLink>
